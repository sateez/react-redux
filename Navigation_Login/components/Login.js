...
'.cls-1{fill:#DBDBDB !important;}'
  ...
  <User className='lock normalSvg' />
    <input type="email" className="form-control pull-right" id="exampleInputEmail1" placeholder="Email"  style={{textAlign:'center',boxShadow:'none',width:'250px',color:'#BDBDBD',letterSpacing:'2px',fontSize:'18px'}} />
  </div>
  <div className="form-group">
		<Lock className='lock normalSvg' />
    <input type="password" className="form-control pull-right" id="exampleInputPassword1" placeholder="Password" style={{textAlign:'center',boxShadow:'none',width:'250px',color:'#FFF',letterSpacing:'10px',fontSize:'18px'}} />
  </div>
