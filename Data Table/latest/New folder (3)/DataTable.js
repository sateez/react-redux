  ...
  render() {
    ...
    return (
      <div>
        ...
        <DraggableContainer>
          <ReactDataGrid onGridSort={this.handleGridSort} rowActionsCell={RowActionsCell} columns={this.state.columns} rowGetter={this.rowGetter} rowsCount={this.getSize()} minHeight={330} enableCellSelect={true} rowRenderer={this.renderRowRenderer()} onAddFilter={this.handleColumnFilterChange} onClearFilters={this.handleClearColumnFilter} toolbar={this.renderFilterToolbar()} rowSelection={{
            showCheckbox: true,
          ...
          }} onRowUpdated={this.handleRowUpdated} getValidFilterValues={this.getValidFilterValues}/>
        </DraggableContainer>
      </div>
    );
  }
