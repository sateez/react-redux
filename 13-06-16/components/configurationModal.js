...
import css from '../css/configurationModal.css'
...
<li className="heading-dup-list-item" >REPORTS</li>
<li className="heading-dup-list-item" >USER SETUP</li>
</ul>
...
<li className="subHeading-dup-list-item" >REPORTS</li>
<li className="subHeading-dup-list-item" >USER SETUP</li>
</ul>
</div>
...
<li className="heading-list-item" >REPORTS</li>
<li className="heading-list-item" >USER SETUP</li>
</ul>
</div>
