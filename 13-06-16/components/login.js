...
<input type="email"  className={props.css.formControl+ ' '+ 'pull-right'} id="loginInputEmail" placeholder="Email"  />
</FormGroup>
<FormGroup  className={props.css.formGroup}>
<Lock className={props.css.lock + ' '+props.css.normalSvg} />
<input type="password"  className={props.css.formControl+ ' '+ 'pull-right'} id="loginInputPassword" placeholder="Password"  />
</FormGroup>
