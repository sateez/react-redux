...
import css from '../css/secondaryNavigation.css'
...
const clickedBack = (e) => {
  ...
  target.toggle('slide',{direction:"right"});
   e.stopPropagation();
}
const SubMenuItem = (props,i) => (
<ul className="subMenulist" key={i}>
<li  key={i} className={props.css.li}><span className='lgListItem'><i className={`fa fa-${props.logo}`}></i><span className='listItem'>{props.label}</span></span>
<span title={props.label}  key={i} className='smListItem' ><i className={`fa fa-${props.logo}`} ></i></span>
...
<li key="sub-li-1" className="subListli">SubItem 1</li>
<li key="sub-li-2" className="subListli">SubItem 2</li>
<li key="sub-li-3" className="subListli">SubItem 3</li>
<li key="sub-li-4" className="subListli">SubItem 4</li>
<li key="sub-li-5" className="subListli">SubItem 5</li>
<li key="sub-li-6" className="subListli">SubItem 6</li>
</ul>
</div>
</li>
</ul>
