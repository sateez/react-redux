...
class AccountsRecievable extends Component {
  ...
  componentDidMount() {
    console.log("general setup props : ", this);
      this.props.setSubSideMenuItem('assm1')   
  }
  render() {
    return (
      <div id="accountsrecievable">
        <h4>ACCOUNTS RECIEVABLE</h4>

        <div className={"asm1" === this.props.currentSideView
          ? ""
          : "hidden"}>
          <h5 id="asm1">ACCOUNTS</h5>

          <h5 id="assm1">type of accounts</h5>
          <Waypoint onEnter={() => {
            this.props.setSubSideMenuItem('assm1')
          }}/>
